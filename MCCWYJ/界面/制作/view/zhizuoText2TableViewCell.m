...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier    {
    ...
    if (self) {
        ...
        _holderTex = [[UIPlaceHolderTextView alloc]initWithFrame:CGRectMake(10, 5, Main_Screen_Width - 20, 100)];
        
        _holderTex.placeholder = @"你就不说点什么吗?";
        [self.contentView addSubview:_holderTex];
        _holderTex.font= AppFont;
        
        _countLbl = [[UILabel alloc]initWithFrame:CGRectMake(0, 106, Main_Screen_Width - 10, 20)];
