...
@interface ReceivingViewController ()<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate>
{
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_isNoData) {
        ...
        [cell prepareNoDataUI:self.view.mj_h TitleStr:@"暂时没有接单信息，点击去接单"];
