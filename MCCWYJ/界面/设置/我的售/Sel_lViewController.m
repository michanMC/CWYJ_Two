...
@interface Sell_ViewController ()<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate>
...
@implementation Sell_ViewController
-(void)didSellObj{
    [self RefreshHeader];
...
- (void)viewDidLoad {
    [super viewDidLoad];
    //监听数据的刷新
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(didSellObj) name:@"didSellObjNotification" object:nil];
