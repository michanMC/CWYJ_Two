...
-(void)addAllSelect{
    ...
    titleSegment.titleTextAttributes = @{NSForegroundColorAttributeName : [UIColor darkTextColor], NSFontAttributeName : [UIFont systemFontOfSize:16]};
    titleSegment.selectedTitleTextAttributes = @{NSForegroundColorAttributeName :       RGBCOLOR(232, 48, 17),NSFontAttributeName : [UIFont systemFontOfSize:16]};
    ...
    titleSegment.selectionStyle = HMSegmentedControlSelectionStyleTextWidthStripe;
